...
from api_testing.conftest import courier_methods, register_new_courier
...
class TestLoginCourier:
    ...
    def test_login_courier_returns_200_and_id(self, courier_methods, register_new_courier):
        new_courier_info = register_new_courier
    ...
    def test_login_without_login_fails(self, courier_methods, register_new_courier):
        new_courier_info = register_new_courier
        login, password, first_name = new_courier_info[0], new_courier_info[1], new_courier_info[2]
